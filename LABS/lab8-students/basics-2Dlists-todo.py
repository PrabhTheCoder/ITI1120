     ...
     for row_index in range(len(m)):
          for column_index in range(len(m[row_index])):
               if row_index <= column_index:
                    summation += m[row_index][column_index]
     return summation
...
def max_over_all_even_cols(m):
     ...
     even_columns = []
     for row_index in range(len(m)):
          for column_index in range(0, len(m[row_index]), 2):
               even_columns.append(m[row_index][column_index])
     
     return max(even_columns)
